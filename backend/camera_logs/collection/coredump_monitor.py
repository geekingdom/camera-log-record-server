...
async def monitor_mount(send, report, target: str, *, interval: float = 60, guard=None):
...
async def run_monitor(collector, server: str, root: str, report, *, guard=None):
    ...
    try:
        ...
        await monitor_mount(send, report, target, guard=guard)
