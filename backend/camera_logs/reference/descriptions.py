...
FIELD_DESCRIPTIONS = {
    ...
    "enableCoredumpMonitor": "是否由此 SSH 或 Telnet 设备任务负责 Coredump NFS 挂载监控。",
...
PARAMETER_DESCRIPTIONS = {
    ...
    "cursor": "认证记录上一页末条返回的游标；传入后使用稳定游标翻页，不能与大于 1 的 page 同用。",
    ...
    "latestAt": "连续状态聚合记录最近一次认证观测时间。",
    "occurrenceCount": "该认证状态在连续区间内被观测到的次数。",
