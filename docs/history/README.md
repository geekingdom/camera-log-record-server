...
- [2026-09-10 本机开发环境重建](2026-09-10-development-reset.md)：用户明确授权删除旧服务与数据后的归属核验、清理和新认证环境验证。
- [2026-09-10 节点看板前状态快照](2026-09-10-before-node-dashboard.md)：当前总表整理前的阶段性描述。

- [工作台交互与作业终态](2026-09-09-workspace-and-job-completion.md)：页签布局、资源快捷建任务、终态审计及剩余恢复边界。

- [浏览器下载授权审计事务](2026-09-09-download-ticket-audit.md)：失败和取消回滚、确认丢失恢复及临时数据清理。

- [日志作业提交与审计事务](2026-09-09-log-job-audit.md)：文件保护、目录快照、作业和审计原子提交，取消与只读恢复。
